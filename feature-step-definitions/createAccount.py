...
driver.get("https://www.Amazon.com")
    # home_logo = driver.find_elements_by_css_selector(".nav-logo-link")
    # print(driver.title)
    # driver.close()
#
...
# @Then ('^I am on the confirm identity security page')
# def i_am_on_the_confirm_identity_security_page():
